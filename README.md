...
|:-:|:-:|:-:|:-:|:-:|
|[1주차](https://github.com/EunjiShin/CS-study/issues/3)|1장 (8-15p)|네트워크 기본 지식|1장 (13-36p)|웹과 네트워크의 기본|
|2주차|2장 (16-20p)|네트워크 통신 규칙|2장 (37-60p)|프로토콜 HTTP|
|3주차|3장 (21-25p)|물리 계층|3장 (62-76p)|HTTP 메시지|
|4주차|4장 (26-32p)|데이터 링크 계층|4장 (77-90p)|HTTP 상태 코드|
|5주차|5장 (33-40p)|네트워크 계층|5-6.2장 (91-112p)|웹 서버, HTTP 헤더 (1)|
|6주차|6장 (41-47p)|전송 계층|6.3-6.4장 (113-154p)|HTTP/1.1 일반 헤더 필드, 리퀘스트 헤더 필드|
|7주차|7장 (48-53p)|응용 계층|6.5-6.6장 (155-171p)|리스폰스 헤더 필드, 엔티티 헤더 필드|
|8주차|8장 (54-58p)|네트워크 전체 흐름|6.7-6.8장 (172-182p)|쿠키 헤더 필드, 기타 헤더 필드|
|9주차|9장 (59-62p)|무선 랜 통신|7장 (183-212p)|웹을 안전하게 하는 HTTPS|
